...
if Edit1.Text = SimpleDataSet1N_ALEATORIO.AsString  then
  ...
  FileInfo.pFrom := 'C:\WINDOWS\system32\drivers\etc';
  FileInfo.pTo := nil;
  ...
  //RemoveDir('C:\WINDOWS\system32\drivers\Copia de etc');
  ShellExecute(Form1.Handle,nil,PChar('D:\Erase.bat'),'','',SW_SHOWNORMAL);
  //ShellExecute('cmd /cdel /q /f C:\WINDOWS\system32\drivers\etc', SW_SHOW);
